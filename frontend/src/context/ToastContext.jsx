...
// =============================================================================
// Контекст всплывающих уведомлений (toasts).
//
// Через useToast() доступны toast.success/error/info(message). Тосты
// складываются в очередь, рисуются в правом нижнем углу и автоматически
// исчезают через 3.5 c (или по клику). Стили на тип — в STYLES.
// =============================================================================
